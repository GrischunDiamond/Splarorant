execute as @a[tag=Team1] at @s run team join LightBlue @s
execute as @a[tag=Team2] at @s run team join LightPurple @s
execute unless entity @a[tag=GameReady,team=!] run function splarorant:farbcombo3
